...
let options = [
  ...
  {
    full: 'update',
    description: 'Update Kinc and its submodules',
    value: false
  },
  {
    full: 'debug',
  ...
  {
    full: 'init',
    description: 'Initialize a Kinc project inside the current directory',
    value: false
  },
  {
    full: 'name',
  ...
  },
  {
    full: 'vscode',
    value: false,
    description: 'Create a vscode project (used automatically by the vscode Kinc extension)'
  },
  {
    full: 'toLanguage',
    value: true,
