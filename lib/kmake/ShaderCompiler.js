    ...
    static findType(platform) {
        switch (platform) {
            case Platform_1.Platform.Android:
                if (Options_1.Options.graphicsApi === GraphicsApi_1.GraphicsApi.Vulkan || Options_1.Options.graphicsApi === GraphicsApi_1.GraphicsApi.Default) {
                    return 'spirv';
                }
                ...
                fs.stat(to, (toErr, toStats) => {
                    ...
                    fs.stat(this.compiler, (compErr, compStats) => {
                        if (!recompile && (fromErr || (!toErr && toStats.mtime.getTime() > fromStats.mtime.getTime() && toStats.mtime.getTime() > compStats.mtime.getTime()))) {
                            ...
                            if (this.platform === Platform_1.Platform.Emscripten || this.platform === Platform_1.Platform.Android) {
