        ...
        if (platform === Platform_1.Platform.Windows) {
            ...
            for (let file of project.getFiles()) {
                if (Project_1.Project.koreDir && Project_1.Project.koreDir.toString() !== '' && !noshaders && file.file.endsWith('.glsl')) {
                    ...
                    const krafix = path.isAbsolute(Project_1.Project.koreDir) ? path.join(Project_1.Project.koreDir, 'Tools', 'krafix', 'krafix.exe') : path.join(from, Project_1.Project.koreDir, 'Tools', 'krafix', 'krafix.exe');
