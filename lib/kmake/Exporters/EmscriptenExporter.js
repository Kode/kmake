...
class EmscriptenExporter extends Exporter_1.Exporter {
    constructor(project, options) {
        ...
        this.make = new MakeExporter_1.MakeExporter(options, 'emcc', 'emcc', '', '', '', '.html', this.libsLine);
        this.ninja = new NinjaExporter_1.NinjaExporter(options, 'emcc', 'emcc', '', '', '', '.html', this.libsLine);
    }
    libsLine(project) {
        let libs = '';
