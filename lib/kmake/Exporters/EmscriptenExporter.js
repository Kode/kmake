...
class EmscriptenExporter extends Exporter_1.Exporter {
    constructor(project, options) {
        ...
        this.make = new MakeExporter_1.MakeExporter(options, emcc, emplusplus, emplusplus, '', '', linkerFlags, '.html');
        this.ninja = new NinjaExporter_1.NinjaExporter(options, emcc, emplusplus, emplusplus, '', '', linkerFlags, '.html');
    }
