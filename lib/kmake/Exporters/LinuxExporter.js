...
class LinuxExporter extends Exporter_1.Exporter {
    constructor(options) {
        ...
        this.ninja = new NinjaExporter_1.NinjaExporter(options, this.getCCompiler(), this.getCPPCompiler(), this.getCPPCompiler(), '', '', linkerFlags, outputExtension);
        this.make = new MakeExporter_1.MakeExporter(options, this.getCCompiler(), this.getCPPCompiler(), this.getCPPCompiler(), '', '', linkerFlags, outputExtension);
